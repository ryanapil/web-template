<title><?=$var["title"]?></title>
        <meta charset="utf-8">
        <base href="<?=$var["url"]?>" target="_self">
        ...
        <meta name="image" content="<?=$var["image_url"]?>">
        <meta itemprop="name" content="<?=$var["title"]?>">
        <meta itemprop="description" content="<?=$var["description"]?>">
        <meta itemprop="image" content="<?=$var["image_url"]?>">
        <meta name="twitter:card" content="summary">
        <meta name="twitter:title" content="<?=$var["title"]?>">
        <meta name="twitter:description" content="<?=$var["description"]?>">
        <meta name="twitter:site" content="<?=$var["handle"]?>">
        <meta name="twitter:creator" content="<?=$var["handle"]?>">
        ...
        <meta name="og:url" content="<?=$var["url"]?>">
